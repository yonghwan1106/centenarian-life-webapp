...
CREATE INDEX idx_checklist_entries_user_date ON public.daily_checklist_entries(user_id, checklist_date DESC);
CREATE INDEX idx_reflections_user_date ON public.daily_reflections(user_id, reflection_date DESC);
